...
const Hero = () => {
  ...
  return (
    ...
    <div className="w-full min-h-screen bg-black md:flex justify-center ">
       ...
       <div className=" md:w-full  md:h-150 bg-[url('src/assets/hhero.jpg')] md:bg-center md:bg-cover ">
       <div className="md:hidden lg:hidden w-full bg-cover bg-right h-60 bg-[url('src/assets/hhero.jpg')]">
