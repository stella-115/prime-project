...
const Card1 = () => {
  return (
    ...
    <div className=" md:w-150 w-full h-130 md:h-150 bg-[#000000f8] md:flex md:justify-center md:ml-150 ml-0">
      <div className="pl-5 pt-13">
        ...
        <button className="md:w-50 w-80 h-15 bg-white rounded-[10px] mt-12 font-bold text-[18px] hover">
