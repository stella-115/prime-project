  ...
  return (
     <div className=" w-full min-h-100 pt-5">
      ...
      <div className="flex justify-center mt-5">
        ...
        <input type="text" placeholder="First and last name" className=" md:w-75 w-57 h-8 md:ml-6 ml-3 mt-1 border border-gray-500 pl-2 rounded-[7px] placeholder:text-[12px] placeholder:text-gray-400 placeholder:font-mono" />
        <h1 className="md:ml-6 ml-3 text-[15px] mt-3">
          Mobile number
        </h1>
        <div>
            <input type="text" placeholder="Nig +123" className=" md:w-20 w-15 h-8 md:ml-6 ml-3 mt-1 border border-gray-500 pl-2 rounded-[7px] placeholder:text-[12px] placeholder:text-gray-400 placeholder:font-mono" />
            <input type="text" placeholder="Mobile number" className=" md:w-50 w-39 h-8 ml-3 md:ml-6 mt-1 border border-gray-500 pl-2 rounded-[7px] placeholder:text-[12px] placeholder:text-gray-400 placeholder:font-mono" />
        </div>
        ...
        <input type="password" placeholder="At least 6 characters" className=" md:w-75 w-57 h-8 md:ml-6 ml-3 mt-1 border border-gray-500 pl-2 rounded-[7px] placeholder:text-[12px] placeholder:text-gray-400 placeholder:font-mono" />
        ...
        <h1 className=" border text-[#D5D9D9] border-[#D5D9D9] md:mt-6 mt-6 md:ml-6 ml-3 md:w-75 w-60 ">
        <hr/>   
        </h1>
          ...
          <h1 className="ml-8 text-[14px] mt-5 flex justify-center items-center gap-2">
