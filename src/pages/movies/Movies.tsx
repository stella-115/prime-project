...
import hero4 from "./../../assets/img/heroo4.png"
...
const Movies = () => {
  return (
   <div className="bg-[url('/imgs/hero4.jpeg')] md:w-full md:min-h-screen min-h-100 w-full bg-cover md:bg-center bg-right flex justify-center bg-[#00050d92]">
      <div className="w-[96%] ">
           <img src={hero4} alt="" className="md:w-100 w-60 pt-55 " />
