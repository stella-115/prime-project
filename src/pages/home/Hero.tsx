...
const Hero = () => {
  ...
  return (
    ...
    <div className="w-full md:min-h-screen bg-black md:flex justify-center md:pt-0 pt-10 ">
       ...
       <div className=" md:w-full  md:h-150 bg-[url('/imgs/hhero.jpg')] md:bg-center bg-right md:bg-cover ">
        <div className="md:hidden lg:hidden w-full bg-cover  bg-right h-80 bg-[url('imgs/hhero.jpg')]">
       </div>
